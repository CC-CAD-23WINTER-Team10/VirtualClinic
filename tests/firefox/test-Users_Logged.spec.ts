...
test('test', async () => {
  ...
  const browser1 = await firefox.launch();  // Or 'chromium' or 'webkit'.
  ...
  const browser2 = await firefox.launch();  // Or 'chromium' or 'webkit'.
  // Create a new incognito browser context.
  ...
  const browser3 = await firefox.launch();  // Or 'chromium' or 'webkit'.
  // Create a new incognito browser context.
  ...
  const browser4 = await firefox.launch();  // Or 'chromium' or 'webkit'.
  // Create a new incognito browser context.
